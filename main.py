...
def setup_cli():
    ...
    parser.add_argument('source', metavar='source', type=str, nargs='+',
                        help='Files/directories to generate the diagram from')
    parser.add_argument('output_dir', metavar='output_dir', type=str, help='Output directory')

    parser.add_argument('-p', '--plantuml', action='store_true', default=True,
                        help='Store PlantUML file (default)')
    parser.add_argument('-i', '--image', action='store_true', default=True,
                        help='Store image file (default)')
